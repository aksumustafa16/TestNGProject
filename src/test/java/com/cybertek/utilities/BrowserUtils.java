...
public class BrowserUtils {
    ...
    public static WebElement waitForVisibility(WebElement element, int timeToWaitInSec) {
        WebDriverWait wait = new WebDriverWait(Driver.get(), Duration.ZERO);
    ...
    public static void waitForPresenceOfElement(By by, long time) {
        new WebDriverWait(Driver.get(), Duration.ZERO).until(ExpectedConditions.presenceOfElementLocated(by));
    }


    public static void waitForClickablility(By xpath, Duration ofSeconds) {
    }
}